<x-admin.layout>
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-h2 text-forest-800">Bingo Items</h2>
    ...
    <div class="hidden md:block bg-pure-white overflow-hidden rounded-card shadow-card">
        <table class="w-full">
            <thead class="bg-forest-50">
                <tr>
                    <th class="px-6 py-3 text-left text-xs font-medium text-forest-700 uppercase tracking-wider">Label</th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-forest-700 uppercase tracking-wider">Punten</th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-forest-700 uppercase tracking-wider">Icon</th>
                    ...
                    <tr class="hover:bg-forest-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end gap-2">
                                <a href="{{ route('admin.bingo-items.edit', $bingoItem) }}" class="p-2 text-sky-600 hover:text-sky-700 hover:bg-sky-50 rounded-button transition-colors" title="Bewerk">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
                                </a>
                                <button x-data="" x-on:click="$dispatch('open-modal', 'delete-bingo-item-{{ $bingoItem->id }}')" class="p-2 text-red-600 hover:text-red-700 hover:bg-red-50 rounded-button transition-colors" title="Verwijder">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
