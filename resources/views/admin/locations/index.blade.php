        ...
        <div class="flex flex-col sm:flex-row gap-3">
            <div class="flex-1">
                <div class="relative">
                    <input
                        ...
                        class="w-full rounded-lg border border-gray-300 px-4 py-2 pl-10 focus:ring-1 focus:ring-sky-500 focus:border-sky-500 focus:outline-none text-deep-black"
                    >
            ...
            <div class="flex gap-3">
                <select
                    id="regioSelect"
                    name="regio"
                    class="rounded-lg border border-gray-300 px-4 py-2 focus:ring-1 focus:ring-sky-500 focus:border-sky-500 focus:outline-none text-deep-black bg-white min-w-[160px]"
                >
                    ...
                    <tr class="hover:bg-sky-50/50 transition-colors cursor-pointer" onclick="window.location='{{ route('admin.locations.edit', $location) }}'">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end gap-2">
                                <a href="{{ route('admin.locations.edit', $location) }}" onclick="event.stopPropagation()" class="p-2 text-sky-600 hover:text-sky-700 bg-sky-50 hover:bg-sky-100 border border-sky-100 rounded-button transition-colors shadow-sm" title="Bewerken">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
                                </a>
                                <button x-data x-on:click.stop="$dispatch('open-modal', 'delete-location-{{ $location->id }}')" class="p-2 text-red-600 hover:text-red-700 bg-red-50 hover:bg-red-100 border border-red-200 rounded-button transition-colors shadow-sm" title="Verwijder">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
