<x-admin.layout>
    ...
    @else
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {{-- Total Responses --}}
            <div class="bg-pure-white rounded-card shadow-card p-5">
                ...
                <p class="text-2xl font-bold text-deep-black">{{ number_format($stats['total_responses']) }}</p>
            </div>
            ...
            <div class="bg-pure-white rounded-card shadow-card p-5">
                ...
                <p class="text-2xl font-bold text-deep-black">{{ number_format($stats['responses_this_month']) }}</p>
            </div>
            ...
            <div class="bg-pure-white rounded-card shadow-card p-5">
                ...
                <p class="text-2xl font-bold text-deep-black">{{ $stats['average_rating'] ?? 'N/A' }}@if($stats['average_rating'])<span class="text-base font-normal text-gray-400"> / 5</span>@endif</p>
            </div>
            ...
            <div class="bg-pure-white rounded-card shadow-card p-5">
                ...
                <p class="text-lg font-bold text-deep-black truncate" title="{{ $stats['most_active_location'] }}">{{ $stats['most_active_location'] }}</p>
            ...
            <div class="bg-pure-white rounded-card shadow-card p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <select
                        ...
                        class="rounded-lg border border-gray-300 pl-3 pr-8 py-1.5 text-sm focus:ring-1 focus:ring-sky-500 focus:border-sky-500 focus:outline-none appearance-none bg-no-repeat bg-right bg-[length:1.25rem]"
