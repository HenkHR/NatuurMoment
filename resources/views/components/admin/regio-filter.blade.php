...
<select
    name="{{ $name }}"
    {{ $attributes->merge(['class' => 'rounded-lg border border-gray-300 px-4 py-2 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-deep-black bg-white min-w-[160px]']) }}
>
