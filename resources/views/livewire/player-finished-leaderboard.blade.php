<div class="h-screen w-full bg-white flex flex-col overflow-hidden">
    ...
    <!-- Header -->
    <div class="w-full px-4 pt-6 pb-8 bg-[#388E3C] flex-shrink-0"
    ...
    <div class="flex-shrink-0 bg-white pt-4 pb-4 px-4 z-50 shadow-lg mt-4">
        <div class="max-w-md mx-auto">
            <button
                ...
                class="w-full bg-[#388E3C] hover:bg-[#43A047] text-white py-3 rounded-lg font-semibold transition shadow-md"
            >
                Verder
            </button>
        </div>
